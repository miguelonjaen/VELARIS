...
import { VELARISAlarm } from '../types';
  ...
  return (
    <div className="fixed top-1 right-50 z-[10000] flex flex-col gap-3 pointer-events-none">
      <div className="flex justify-center pointer-events-auto">
        ...
        >
          {isMuted ? <BellOff size={12} /> : <Zap size={10} className="animate-pulse" />}
          ...
          >
            ...
            <div className="flex items-start gap-3 relative z-10">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-bold leading-tight mt-1 mb-1">{alarm.message}</p>
              </div>
